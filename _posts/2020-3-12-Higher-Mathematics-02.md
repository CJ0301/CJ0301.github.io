...
$$\lim\limits_{\Delta x\rightarrow0}\frac{x_0+\Delta x-f(x_0)}{\Delta x}可以被广义化为\lim\limits_{g(x)\rightarrow0}\frac{f(x_0+g(x))-f(x_0)}{g(x)}$$
...
🌰例1.$$设f(x)是二阶可导的以2为周期的奇函数，且f(\frac{1}{2})>0，f'(\frac{1}{2})>0，比较f(-\frac{1}{2})，f'(\frac{3}{2})与f''(0)的大小，并说明理由$$

$$
1）f(x)奇\Rightarrow f'(x)偶\Rightarrow f''(x)奇 \Rightarrow f''(0)=0 \\
2）f(-\frac{1}{2})=-f(\frac{1}{2})<0
3）f(x)T=2 \Rightarrow f'(x)T=2 \Rightarrow \\
f'(\frac{3}{2})=f'(-\frac{1}{2})=f'(\frac{1}{2})>0 \\
\Rightarrow f'(\frac{3}{2})>f''(0)>f(-\frac{1}{2})
$$
...
四、反函数求导法则  
$$设y=f(x)可导，且f'(x)\neq0,则存在反函数x=\phi(y)，且\frac{dx}{dy}=\frac{1}{\frac{dy}{dx}}，即\phi'(y)=\frac{1}{f'(x)}$$
