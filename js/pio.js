    ...
    var action = {
        ...
        buttons: function () {
            ...
            elements.info.onclick = function () {
                window.open(prop.content.link || "https://www.cjcjcj.top/about");
            };
            elements.info.onmouseover = function () {
                modules.render("想了解更多关于我主人的信息吗？");
            };
                    ...
                    for(var j = 0; j < e.length; j++){
                        if(t.type === "read"){
                            e[j].onmouseover = function () {
                                modules.render("想阅读主人写的 %t 吗？😉".replace(/%t/, "“" + this.firstElementChild.firstElementChild.innerText + "”"));
                            }
                        }
						else if(t.type === "previous"){
							e[j].onmouseover = function () {
                                modules.render("上一页有惊喜噢🎊");
                            }
						}
						else if(t.type === "next"){
							e[j].onmouseover = function () {
                                modules.render("下一页有惊喜噢🎉");
                            }
						}
						else if(t.type === "rocket"){
							e[j].onmouseover = function () {
                                modules.render("坐着小火箭🚀一起飞吧！");
                            }
						}
						else if(t.type === "beian"){
							e[j].onmouseover = function () {
                                modules.render("接受人民的监督噢😎");
                            }
						}
